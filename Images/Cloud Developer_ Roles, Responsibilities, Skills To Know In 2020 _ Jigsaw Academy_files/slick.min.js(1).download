...
$('.related-article-carousel').slick({
	dots: true,
	infinite: true,
	autoplay: false,
	speed: 300,
...
$('.category-tool-carousel-1').slick({
	dots: true,
	infinite: true,
	autoplay: false,
	speed: 300,
